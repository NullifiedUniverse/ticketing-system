            ...
            <div className="flex items-center justify-end gap-2">
                ...
                {ticket.status !== 'checked-in' && (
                    <motion.button
                        ...
                        className="px-3 py-2 animated-gradient-bg hover:brightness-110 text-white text-xs font-bold rounded-lg shadow-lg shadow-indigo-500/20 flex items-center gap-1 transition-all"
                        title={t('btnCapture')}
                    >
